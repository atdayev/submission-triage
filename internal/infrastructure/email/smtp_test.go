...
func TestBuildMessage_MarksAutoGenerated(t *testing.T) {
	s := testSMTP(nil)
	msg := string(s.buildMessage(model.Reply{ToAddress: "broker@x", Subject: "Re: thread", BodyText: "b"}, "mid@host"))
	if !strings.Contains(msg, "Auto-Submitted: auto-generated\r\n") {
		t.Errorf("reply not marked auto-generated (RFC 3834):\n%s", msg)
	}
}
